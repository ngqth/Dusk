...
static int wsindicatortype               = INDICATOR_BOTTOM_BAR;
...
static const char *fonts[]               = { "SFMono Nerd Font:size=10" };
static       char dmenufont[]            = "SFMono Nerd Font:size=10";
...
static const char *const autostart[] = {
        ...
        /* "sh", "-c", "sleep 5 && ./.config/polybar/launch.sh &", NULL, */
        /* "sh", "-c", "dwm_bar &", NULL, */
        /* "sh", "-c", "openweathermap &", NULL, */
        /* "sh", "-c", "download.sh &", NULL, */
        /* "sh", "-c", "sleep 5s; arch.sh &", NULL, */
	NULL /* terminate */
};
...
static const Rule clientrules[] = {
	...
	{ .role = "browser", .workspace = "3", .flags = AttachBelow|OnlyModButtons|SwitchWorkspace },
	...
	{ .class = "St", .workspace = "2", .flags = Terminal|AttachBottom|SwitchWorkspace },
...
static const WorkspaceRule wsrules[] = {
	...
	{  "1",   -1,       0,       3,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "1",   "",   "[1]", },
	{  "2",   -1,       0,       1,       .80,   -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "[2]", },
	...
	{  "7",   -1,       0,       0,      .75,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "7",   "",   "[7]", },
...
static const char *termcmd[]  = { NULL, "st", "-e", "tmux", NULL };
